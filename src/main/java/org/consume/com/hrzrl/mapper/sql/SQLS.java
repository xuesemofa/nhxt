package org.consume.com.hrzrl.mapper.sql;
...
public class SQLS {
    ...
    public String sel1(Map<Integer, String> map) {
        ...
        String sql = "SELECT"
                ...
                + " 	SUM(d.acc_hea) * 1000000000 / h.mj / " + map.get(6) + " hrzrzb"
                + " FROM"
                + " 	heat_table h"
    ...
    public String sel2(Map<Integer, String> map) {
        ...
        String sql = "SELECT"
                ...
                +" 	d.acc_hea * 1000000000 / h.mj / " + map.get(6) + " hrzrzb"
                +" FROM"
                +" 	heat_table h"
                +" LEFT JOIN crew_table c ON c.parents = h.uuid"
                +" LEFT JOIN datas_2_1_table d ON d.jzid = c.uuid"
    ...
    public String sel3(Map<Integer, String> map) {
        ...
        String sql = "SELECT"
                ...
                + " 	c.mj jzmj,"
                + " 	d.acc_hea / c.mj rhrl,"
                + " 	d.acc_hea*1000000000 / c.mj / " + map.get(4) + " rrzb"
                + " FROM"
                + " 	datas_2_table d"
    ...
    public String sel5(Map<Integer, String> map) {
        String s = " CONVERT(hrzmc USING gbk)";
        String q = " ";
        if (map.containsKey(2) && map.containsKey(3)) {
            s = map.get(2).equals("") ? " CONVERT(hrzmc USING gbk)" : map.get(2);
        ...
        String sql = "SELECT"
                +"  a.hrzmc,a.hrzmj,SUM(a.ywljrl),a.hrzrdh,a.hrzrzb "
                +"  FROM "
                +"  (SELECT "
                +" 	h.`names`,c.`names` hrzmc,"
                +" 	c.mj hrzmj,"
                +" 	d.acc_hea ywljrl,"
                +" 	d.acc_hea / h.mj hrzrdh,"
                +" 	d.acc_hea * 1000000000 / h.mj / " + map.get(6) + " hrzrzb"
                ...
                +" 	c.mj"
                +" ORDER BY ";
        return sql + s + q+") a GROUP BY a.`names`";
    }
